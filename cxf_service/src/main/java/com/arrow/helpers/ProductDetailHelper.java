...
public class ProductDetailHelper {
    public static ProductDetailModel addProductDetail(ProductDetailServiceModel productDeatilServiceModel) {
        ProductDetailModel productDetailModel = new ProductDetailModel(productDeatilServiceModel.getShopperId(), productDeatilServiceModel.getSerial(), productDeatilServiceModel.getSupplier(), productDeatilServiceModel.getInvoiceNumber(), productDeatilServiceModel.getOrderId(), productDeatilServiceModel.getDateOfPurchase(), productDeatilServiceModel.getSupplierAddress(), productDeatilServiceModel.geteCommerceSupplier());
